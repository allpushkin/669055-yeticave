...
<form class="form form--add-lot container <?=$classname;?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
  ...
  <div class="form__item form__item--wide <?=$classname;?>">
    ...
    <?php 
      $classname = isset($errors['img_path']) ? 'form__item--invalid' : '';
  ...
  <div class="form__container-three">
    ...
    <?php
      $classname = isset($errors['starting_price']) ? 'form__item--invalid' : '';
    ...
    <?php 
      $classname = isset($errors['bed_step']) ? 'form__item--invalid' : '';
    ...
    <?php 
      $classname = isset($errors['date_end']) ? 'form__item--invalid' : '';
